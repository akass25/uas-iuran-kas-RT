    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a href="<?= route_to('warga') ?>" class="nav-link">Data Warga</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= route_to('iuran') ?>" class="nav-link">Iuran Kas</a>
                        </li>
                        <li class="nav-item">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                Akas Suherman - 312010099
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; <?= date('Y') ?> <a href="#">Akas Suherman - 312010099</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
